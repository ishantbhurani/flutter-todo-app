...
void _todoSerialize(
  ...
  writer.writeBool(offsets[1], object.status);
...
Todo _todoDeserialize(
  ...
  final object = Todo(
    ...
    priority: _TodopriorityValueEnumMap[reader.readByteOrNull(offsets[0])] ??
        Priority.low,
    status: reader.readBoolOrNull(offsets[1]) ?? false,
  );
  object.id = id;
  return object;
}
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> statusEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
        value: value,
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, bool, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
